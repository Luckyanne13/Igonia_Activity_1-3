package com.example.igonia_application
...
import com.example.igonia_application.R
    ...
    Column {
        ...
        Text(
            text = "In this tutorial, you build a simple Ul component " +
                    ...
                    "the UI construction, such as initializing an " +
    ...
    Box (
        ...
        Card( //q1
            colors = CardDefaults.cardColors(
                containerColor = Color(25, 240, 102),
        ...
        Card( //q4
            colors = CardDefaults.cardColors(
                containerColor = Color(0, 255, 204),
            ),
            shape = RectangleShape,
            modifier = Modifier
                .fillMaxWidth(0.5f)
